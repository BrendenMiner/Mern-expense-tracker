    ...
    <form
      ...
      <div className="flex flex-col space-y-1">
        ...
        <textarea
          ...
          rows="3"
          className="w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"></textarea>
